  ...
  <nav class="brown  lighten-3">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li> <a class="black-text" <?php if ($paginaCorrente == 'index02.php') {
                                      echo 'style="text-decoration: underline;"';
                                    } ?> href="index02.php">Home</a></li>
        <li> <a class="black-text" <?php if ($paginaCorrente == 'clientes1.php') {
                                      echo 'style="text-decoration: underline;"';
                                    } ?> href="clientes1.php">Clientes</a></li>
        <li> <a class="black-text" <?php if ($paginaCorrente == 'quem.php') {
                                      echo 'style="text-decoration: underline;"';
                                    } ?> href="quem.php">Nós!</a></li>
        <li> <a class="black-text" <?php if ($paginaCorrente == 'destinos.php') {
                                      echo 'style="text-decoration: underline;"';
                                    } ?> href="destinos.php">Destinos</a></li>
      </ul>
    </div>
  </nav>
</div>
